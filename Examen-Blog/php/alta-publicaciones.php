		...
		?>
			<div class="altaNoticia">
				...
				<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">  
					...
					<br><br>
					<label for="fcontenido">Descripción: </label><textarea type="text" name="contenido" rows="10" cols="50" maxlength="500" id="fcontenido"><?php echo $contenido;?></textarea><span class="error"><?php echo $contenidoError;?></span>
					<br><br>
